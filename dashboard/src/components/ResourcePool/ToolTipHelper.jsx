    ...
    <>
      <div className="flex flex-wrap">
        <div className="w-full text-center">
          <button
            className={
              `bg-${color}-500 text-black active:bg-${color}-600 font-bold uppercase text-sm px-2 rounded-full shadow hover:shadow-lg transform hover:scale-125 outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150`
            }
            type="button"
